...
const initialOrders: GarnishmentOrderWithTimeline[] = [
  ...
  {
    id: "7",
    caseNumber: "JANE DOE ENTERPRISES, INC.",
  ...
  {
    id: "8",
    caseNumber: "Graf Linke e.V. GMBH",
